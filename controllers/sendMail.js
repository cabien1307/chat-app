...
const sendEmail = (to, url, txt) => {
    ...
    const mailOptions = {
        ...
        html: `
            ...
            <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to the TunKit channel.</h2>
            <p>Congratulations! You're almost set to start using TunKit.
